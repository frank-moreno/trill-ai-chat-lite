...
(function () {
    ...
    function buildLauncher() {
        ...
        // Classic bubble variant (v2.1, launcher_style='bubble') — round
        // primary-coloured circle with a white chat glyph. Kept in sync
        // with chat-widget.js::render() so there is no visual shift when
        // the full widget takes over.
        if (cfg.launcher_style === 'bubble') {
            btn.className += ' trcl-chat-toggle--bubble';
            btn.innerHTML = '' +
